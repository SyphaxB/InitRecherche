...
def main():
    ...
    dblp_path = '/home/halcyon/Téléchargements/dblp-data/dblp.xml'
    save_path = '/home/halcyon/Téléchargements/dblp-data/'
    #save_path = '/home/halcyon/Téléchargements/dblp-data/target_x.xml'
    try:
        ...
        exit()
    #parse_inproceedings(dblp_path, save_path, save_to_csv=True, include_key=True)
    #parse_article(dblp_path, save_path, save_to_xml=True, include_key=False)
    parse_inproceedings(dblp_path, save_path, save_to_csv=True, include_key=False)
    #parse_book(dblp_path, save_path, save_to_csv=True, include_key=False)
